...
export const Routes = {
  ...
  caballoNuevo:        '/(tabs)/caballos/nuevo',
  caballoEditar:       (id: string) => `/(tabs)/caballos/${id}/editar`,
  caballoSanidadNuevo: (id: string) => `/(tabs)/caballos/${id}/sanidad-nuevo`,
  caballoEventoNuevo:  (id: string) => `/(tabs)/caballos/${id}/evento-nuevo`,
  perfilEditar:        '/(tabs)/perfil/editar',
  perfilContrasena:    '/(tabs)/perfil/contrasena',
