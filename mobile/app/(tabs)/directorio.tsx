...
const makeStyles = (c: ThemeColors) => StyleSheet.create({
  ...
  searchWrap: { flexDirection: 'row', alignItems: 'center', gap: space[2], marginHorizontal: space[4], marginVertical: space[3], backgroundColor: c.isDark ? c.surfaceAlt : '#f1f2f4', borderRadius: radius.lg, paddingHorizontal: space[3], paddingVertical: 2 },
