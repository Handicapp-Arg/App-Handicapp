...
const makeStyles = (c: ThemeColors) => StyleSheet.create({
  ...
  textarea: { borderWidth: 1, borderColor: c.borderStrong, borderRadius: radius.md, paddingHorizontal: space[4], paddingVertical: space[3], fontSize: text.md, color: c.text, backgroundColor: c.surfaceAlt, height: 100, textAlignVertical: 'top' },
  ...
  stepperBtn: { width: 44, height: 44, borderRadius: radius.md, borderWidth: 1, borderColor: c.borderStrong, backgroundColor: c.surface, justifyContent: 'center', alignItems: 'center' },
