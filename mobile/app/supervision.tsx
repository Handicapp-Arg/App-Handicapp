...
const makeStyles = (c: ThemeColors) => StyleSheet.create({
  ...
  statValue: { fontSize: text['2xl'], fontWeight: weight.extrabold, color: c.text },
  ...
  feedTitle: { fontSize: text.sm, fontWeight: weight.semibold, color: c.text },
  feedDetail: { fontSize: text.xs, color: c.textMuted, lineHeight: 16 },
  feedMeta: { flexDirection: 'row', alignItems: 'center', gap: space[1], marginTop: 2, flexWrap: 'wrap' },
  feedHorse: { fontSize: text.xs, fontWeight: weight.semibold, color: c.brand, maxWidth: 130 },
  feedAuthor: { fontSize: text.xs, color: c.textFaint, maxWidth: 110 },
  feedTime: { fontSize: text.xs, color: c.textFaint },
