...
/**
 * Logos OFICIALES de medios de pago sobre "chips" tipo tarjeta.
 * Los paths/colores son los oficiales de cada marca (ver PaymentMethods.tsx
 * en mobile: se mantienen idénticos para paridad web↔móvil).
 *  - Visa: wordmark oficial (Simple Icons) en azul #1434CB.
 *  - Mastercard: símbolo oficial (2 círculos + intersección naranja).
 *  - Amex: "blue box" oficial (recuadro azul + AMERICAN EXPRESS).
 *  - MercadoPago: isologo oficial (handshake, Simple Icons), sin texto "MP".
...
function VisaLogo() {
  return (
    <svg viewBox="0 8.2 24 7.56" width={26} height={8.2} role="presentation">
      <path
        fill="#1434CB"
...
function MastercardLogo() {
  return (
    <svg viewBox="0 0 40 24" width={24} height={14.4} role="presentation">
      <defs>
        <clipPath id="mc-lens">
...
function MercadoPagoLogo() {
  return (
    <svg viewBox="0 0 40 26" width={40} height={26} role="presentation">
      ...
      <g transform="translate(9.2 2.2) scale(0.9)" fill="#ffffff">
        <path d={MP_HANDSHAKE_PATH} />
      </g>
    </svg>
  );
}
