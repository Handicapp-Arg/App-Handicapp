...
export function SkeletonCard() {
  return (
    <div className="rounded-2xl border border-[var(--surface-card-border)] bg-[var(--surface-card)] p-4 space-y-3">
...
export function SkeletonRow() {
  return (
    <div className="flex items-center gap-3 rounded-xl border border-[var(--surface-card-border)] bg-[var(--surface-card)] px-4 py-3">
...
export function SkeletonStat() {
  return (
    <div className="rounded-2xl border border-[var(--surface-card-border)] bg-[var(--surface-card)] p-4 space-y-2">
...
export function Spinner({ size = 'md', color = 'primary' }: { size?: 'sm' | 'md' | 'lg'; color?: 'primary' | 'white' | 'gray' }) {
  ...
  const colors = {
    primary: 'border-[var(--surface-card-border)] border-t-[var(--color-primary)]',
