  ...
  return (
    <div ref={wrapRef} className="relative">
      ...
      {open && query.trim().length >= 2 && (
        <div className="absolute left-0 right-0 top-full mt-1 z-50 rounded-xl border border-gray-200 bg-white shadow-2xl overflow-hidden max-h-80 overflow-y-auto">
          ...
          {data?.horses && data.horses.length > 0 && (
            <div>
              ...
              {data.horses.map((h) => (
                ...
                >
                  <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-[#0f1f3d] text-xs font-bold text-white">
