    ...
    <>
      ...
      <div className="fixed inset-0 z-[999] flex flex-col bg-[var(--surface-card)] sm:hidden">
        <div className="flex items-center justify-between border-b border-[var(--surface-card-border)] px-5 py-4">
          <p className="text-base font-semibold text-gray-900">Editar caballo</p>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col flex-1 overflow-hidden">
          ...
          <div className="border-t border-[var(--surface-card-border)] p-5 space-y-3">
            <button type="submit" disabled={isPending}
              className="w-full rounded-xl bg-clay-500 py-3.5 text-sm font-semibold text-white transition hover:bg-clay-600 disabled:opacity-50 cursor-pointer">
              {isPending ? 'Guardando...' : 'Guardar cambios'}
            </button>
            <button type="button" onClick={onClose}
              className="w-full rounded-xl border border-gray-200 py-3.5 text-sm font-medium text-gray-600 transition hover:bg-gray-50 cursor-pointer">
              Cancelar
            </button>
          </div>
        </form>
      ...
      <div className="fixed inset-0 z-[999] hidden sm:flex items-center justify-center p-4">
        <div className="relative flex flex-col w-full max-w-lg rounded-2xl bg-[var(--surface-card)] shadow-2xl overflow-hidden" style={{ maxHeight: '88dvh' }}>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col overflow-hidden">
            ...
            <div className="flex gap-2 border-t border-[var(--surface-card-border)] p-4">
              <button type="button" onClick={onClose}
  ...
  return (
    <div className="space-y-6">
      ...
      {recordMatches && createPortal(
        <>
          <div className="fixed inset-0 z-[998] bg-[var(--overlay)] backdrop-blur-sm" onClick={() => setRecordMatches(null)} />
          <div className="fixed inset-0 z-[999] flex items-end sm:items-center justify-center p-0 sm:p-4">
            <div className="w-full sm:max-w-md bg-[var(--surface-card)] rounded-t-2xl sm:rounded-2xl shadow-2xl overflow-hidden">
              <div className="flex items-start justify-between border-b border-[var(--surface-card-border)] px-5 py-4">
                <div>
                  <p className="text-base font-semibold text-gray-900">Posibles coincidencias</p>
                  <p className="text-xs text-gray-400 mt-0.5">Encontramos este caballo en el padrón oficial</p>
                </div>
                <button onClick={() => setRecordMatches(null)} aria-label="Cerrar" className="inline-flex h-8 w-8 items-center justify-center rounded-lg text-gray-400 transition hover:bg-gray-100 hover:text-gray-700 cursor-pointer"><X className="h-5 w-5" /></button>
              </div>
                ...
                {recordMatches.matches.map((r) => (
                  <div key={r.id} className="flex items-center gap-3 rounded-xl border border-gray-200 bg-gray-50 p-3">
                    ...
                    <button
                      ...
                      className="shrink-0 rounded-lg bg-clay-500 px-3 py-2 text-xs font-semibold text-white transition hover:bg-clay-600 disabled:opacity-50 cursor-pointer"
                    >
              ...
              <div className="border-t border-[var(--surface-card-border)] px-5 py-4">
                <button onClick={() => setRecordMatches(null)} className="w-full rounded-xl border border-gray-200 py-2.5 text-sm font-medium text-gray-600 transition hover:bg-gray-50 cursor-pointer">
                  Omitir por ahora
                </button>
              </div>
            </div>
      ...
      {showForm && createPortal(
        <>
          ...
          <div className="fixed inset-0 z-[999] flex flex-col bg-[var(--surface-card)] sm:hidden">
            <div className="flex items-center justify-between border-b border-[var(--surface-card-border)] px-5 py-4">
              <p className="text-base font-semibold text-gray-900">Nuevo caballo</p>
              <button onClick={closeCreateForm} aria-label="Cerrar" className="inline-flex h-8 w-8 items-center justify-center rounded-lg text-gray-400 transition hover:bg-gray-100 hover:text-gray-700 cursor-pointer"><X className="h-5 w-5" /></button>
            </div>
          ...
          <div className="fixed inset-0 z-[999] hidden sm:flex items-center justify-center p-4">
            <div className="relative flex flex-col w-full max-w-2xl rounded-2xl bg-[var(--surface-card)] shadow-2xl overflow-hidden" style={{ maxHeight: '90dvh' }}>
              {/* Header */}
              <div className="flex items-start justify-between border-b border-[var(--surface-card-border)] px-6 py-4">
                <div>
                  <p className="text-base font-semibold text-gray-900">Nuevo caballo</p>
              ...
              <form onSubmit={handleCreate} className="flex flex-col overflow-hidden">
                ...
                <div className="flex justify-end gap-2 border-t border-[var(--surface-card-border)] px-6 py-4">
                  <button type="button" onClick={closeCreateForm}
                    className="rounded-xl border border-gray-200 px-5 py-2.5 text-sm font-medium text-gray-600 transition hover:bg-gray-50 cursor-pointer">
                    Cancelar
                  </button>
