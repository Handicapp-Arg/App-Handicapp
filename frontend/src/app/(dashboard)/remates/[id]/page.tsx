    ...
    <div className="flex items-center gap-2">
      {[{ v: d, l: 'd' }, { v: h, l: 'h' }, { v: m, l: 'm' }, { v: s, l: 's' }].map(({ v, l }) => (
        <div key={l} className="text-center">
          <div className="rounded-lg bg-[#0f1f3d] text-white font-bold text-lg leading-none px-2.5 py-1.5 min-w-[36px]">
  ...
  if (isLoading || !auction) {
    return (
      <div className="flex h-full items-center justify-center">
        <div className="h-8 w-8 animate-spin rounded-full border-2 border-[#0f1f3d] border-t-transparent" />
      </div>
    );
  }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-6xl">
                  ...
                  <div className="space-y-2">
                    {bids.map((b) => (
                      <BidRow
                        ...
                        isSeller={isSeller}
                        onAccept={
                          isSeller && auction.type === 'venta_directa'
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
              ...
              <p className="text-3xl font-extrabold text-[#0f1f3d] tracking-tight">
                {formatCurrency(
              ...
              {!isSeller && isActive && isRemate && (
                <div className="mt-4 space-y-2">
                  <div className="flex gap-2">
                    <input
                      type="number"
                      className="flex-1 rounded-lg border border-gray-200 px-3 py-2 text-sm focus:border-[#0f1f3d] focus:ring-2 focus:ring-[#0f1f3d]/10 focus:outline-none"
            ...
            <div className="rounded-2xl border border-gray-100 bg-white p-4">
              ...
              <div className="flex items-center gap-2.5">
                <div className="h-9 w-9 rounded-full bg-[#0f1f3d]/10 flex items-center justify-center font-bold text-[#0f1f3d] text-sm">
