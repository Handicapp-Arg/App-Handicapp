      ...
      {isOpen &&
        createPortal(
          <div className="animate-fade-in fixed inset-0 z-[60] flex items-start justify-center p-4 pt-[10vh]">
            ...
            <div className="animate-modal-in relative flex w-full max-w-xl flex-col overflow-hidden rounded-2xl border border-slate-200 bg-[var(--surface-card)] shadow-2xl">
